...
# 2 "<built-in>" 2
# 1 "conversionTemp.c" 2
# 11 "conversionTemp.c"
# 1 "./conversionTemp.h" 1
# 16 "./conversionTemp.h"
...
# 122 "conversionTemp.c"
  resetWatch = 0;
        switch(lectRom2[0]){
# 132 "conversionTemp.c"
            case 0x10:{
                aux2=aux20;
